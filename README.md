...
![image](https://github.com/Jigyasa777/analytics-engineering-prototype/blob/main/img/dbt-bigquery.png)
...
The company is struggling to keep up with reporting requirements, which cause the database performance to degrade, negatively impacting their daily business operations. Their goal now is to modernize their data and reporting solution and move away from on-prem infrastructure. The new solution must achieve:
...
Database Diagram
![image](https://github.com/Jigyasa777/analytics-engineering-prototype/blob/main/img/northwind-oltp-erd.png)
...
##### Sales Overview
Overall sales reports to understand better our customers what is being sold, what sells the most, in what locations, and also what sells the least. This is for a general overview of how the business is going.

##### Sales Agent Tracking
Tracking sales and performance of each sales agent to adjust commissions, reward high performers and empower low performers.
...
![image](https://github.com/Jigyasa777/analytics-engineering-prototype/blob/main/img/Architecture.png)
...
![image](https://github.com/Jigyasa777/analytics-engineering-prototype/blob/main/img/ae-bootcamp-erd-physical.drawio.png)
...
## Maintainer
Jigyasa is a Data Engineer with over 3 years of experience specializing in the design of scalable ETL/ELT pipelines, cloud-native data platforms, and modern Lakehouse architectures. With expertise in SQL, Python, and PySpark, she focuses on delivering high-performance analytics solutions that drive business value.

Contact:
- GitHub: https://github.com/Jigyasa777
- LinkedIn: https://linkedin.com/in/jigyasa-kang-j7
- Email: jigyasa17034@gmail.com